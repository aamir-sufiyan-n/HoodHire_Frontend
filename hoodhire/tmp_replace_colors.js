...
function processFile(filePath) {
    ...
    content = content.replace(/#009966/g, '#134074'); // Primary
    content = content.replace(/#008855/g, '#13315C'); // Hover
    content = content.replace(/#dff5ea/g, '#EEF4ED'); // Emerald-50 eq
    content = content.replace(/#f0faf5/g, '#EEF4ED');
    ...
    // We only want to replace bg-white, not text-white or border-white
